    ...
    <div className={`${isCollapsed ? 'w-16' : 'w-64'} sidebar bg-white/95 backdrop-blur-sm border-r border-gray-200/60 flex flex-col h-full shadow-xl transition-all duration-300`}>
      ...
      <div className="px-4 py-2 border-b border-gray-200/60">
        <button
          ...
          className={`w-full flex items-center ${isCollapsed ? 'justify-center px-2' : 'space-x-3 px-3'} py-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors duration-200 group`}
        ...
        >
          ...
          {!isCollapsed && <span className="text-sm font-medium">开始新对话</span>}
        </button>
      </div>
